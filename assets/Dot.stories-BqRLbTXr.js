import{j as r}from"./jsx-runtime-BjG_zV1W.js";import{D as o}from"./Dot-PwSJpuBs.js";import{S as m}from"./Stack-BZ4gPDOg.js";import"./index-Ca8FO3x4.js";import"./Box-4S6i-Boh.js";import"./DefaultPropsProvider-7SHxphPT.js";const f={title:"展示元件/Dot",component:o,parameters:{layout:"centered"},argTypes:{color:{control:{type:"color",presetColors:["red","green"]}}},tags:["autodocs"]},e={name:"預設",args:{color:"primary",label:"狀態",size:8,placement:"end"}},a={name:"顏色",render:()=>r.jsxs(m,{spacing:1,justifyContent:"start",children:[r.jsx(o,{color:"red",label:"default"}),r.jsx(o,{color:"primary",label:"primary"}),r.jsx(o,{color:"secondary",label:"secondary"}),r.jsx(o,{color:"success",label:"success"}),r.jsx(o,{color:"warning",label:"warning"}),r.jsx(o,{color:"error",label:"error"}),r.jsx(o,{color:"info",label:"info"})]})};var s,t,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  name: '預設',
  args: {
    color: 'primary',
    label: '狀態',
